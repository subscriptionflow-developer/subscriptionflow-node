...
const apiSeparatedRepositoryModules = {
  // 'customers': CustomersRepository,
  // 'orders': OrdersRepository
};
const apiSeparatedRepositoryKeys = Object.keys(apiSeparatedRepositoryModules);
...
class Client {
  ...
  setDynamicPropsForEnabledModule(client) {
    apiEnabledModules.forEach((module) => {
      ...
      if(apiSeparatedRepositoryKeys.includes(module) ) {
        this[module] = new apiSeparatedRepositoryModules[module](client);
      } else {
